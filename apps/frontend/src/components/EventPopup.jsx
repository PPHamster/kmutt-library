...
export default function Eventpopup(props) {
    const imageStyle = 'max-h-[260px] max-w-[225px] rounded-lg object-scale-down max-lg:w-[60%] max-lg:max-h-[240px] max-sm:max-h-[200px]';
    const textStyle = 'text-base font-kanit text-[#696969] mt-3  max-lg:mt-1 max-lg:text-sm';
    const textStyle2 = 'text-base font-kanit text-[#696969] mt-3 mb-3 max-lg:mt-1 max-lg:text-sm max-lg:mb-0';
    ...
    return (
        <>
            <div className="fixed flex justify-center items-center  top-0 left-0 right-0 bottom-0 h-screen bg-black/50 z-[40]">
                {/* // row */}
                <div className="flex flex-wrap w-[62%] min-h-[450px] max-h-[500px] rounded-lg shadow-lg shadow-gray-700 max-lg:flex-col max-lg:h-[750px]">

                    {/* side */}
                    <div className="w-[35%] justify-center items-center flex rounded-l-lg bg-white max-lg:w-full max-lg:rounded-t-lg max-lg:rounded-none max-sm:h-[40%] max-lg:h-[48%]">
                        <img src={props.event.image} className={imageStyle} />
                    </div>
                    {/* detail */}
                    <div className="w-[65%] px-[20px] pt-[5%] bg-white rounded-r-lg pb-3 max-sm:h-[60%] max-lg:w-full max-lg:rounded-b-lg max-lg:h-[52%] max-lg:rounded-none">
                        ...
                        <button
                            className="w-[140px] h-[30px] mx-[45px] max-lg:mx-[80px] max-sm:mx-[10px] rounded-full bg-white border-2 hover:bg-gray-200 font-regular font-kanit text-[#696969] my-[20px] ease-out duration-300"
                            onClick={props.onClick}
