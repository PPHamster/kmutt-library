      ...
      <div className="relative max-w-[95vw] top-[15vh] ml-[60px] mb-[200px] ">
        ...
        <div className='relative flex flex-col mt-14 pb-14 ml-[1vw] w-[90vw] min-h-[500px] bg-[#f4f4f4] rounded-lg'>
          {myblogs.map((blog) => {
            ...
            return (
              <div className="w-[80vw] ml-[5vw] mt-[40px] min-h-[333px] bg-white rounded-md drop-shadow-md" key={blog.id}>
                <div className="flex flex-row">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="h-auto mb-2">
                      <p className="w-[60vw] font-kanit font-light text-md whitespace-normal truncate text-gray-500 mt-3 ml-2">{blog.article}</p>
                    </div>
                    ...
                    <p><button
                      className=" w-[80px] p-3 mb-5 mt-2 rounded-full bg-[#0092BF]  hover:bg-[#007396] border-2 font-regular font-poppins text-white ease-out duration-300"
                      onClick={() => { handleOpenEdit(blog) }}>Edit</button>
                      <span className="mt-[100px]">
                        <button
                          className="w-auto p-3 mx-[20px] translate-y-1 rounded-full bg-[#F44336] border-2 hover:bg-[#c5342a] font-regular font-poppins text-white text-md ease-out duration-300"
