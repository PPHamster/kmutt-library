...
const bloglist = [
    { id: 1, topic: 'topic', article: 'very good1', createdAt: '2023-01-01 10:00:00', updatedAt: '2023-01-01 11:11:11', book: { id: 7, title: 'test', image: '../bookimages/chainsawman_volume_1.jpg' }, tags: [{ id: 1, name: 'Manga' }, { id: 3, name: 'Review' }] },
    { id: 2, topic: 'topic', article: 'very good2', createdAt: '2023-01-01 10:00:00', updatedAt: '2023-01-01 11:11:11', book: { id: 8, title: 'test1', image: '../bookimages/that_time_i_got_reincarnated_as_a_slime_volume_1.jpeg' }, tags: [{ id: 1, name: 'Manga' }, { id: 5, name: 'Review2' }] },
    { id: 3, topic: 'topic', article: 'very good3', createdAt: '2023-01-01 10:00:00', updatedAt: '2023-01-01 11:11:11', book: { id: 9, title: 'test3', image: '../bookimages/lycoris_recoil_volume_1.jpg' }, tags: [{ id: 1, name: 'Manga' }] },
    { id: 4, topic: 'topic', article: 'very good4', createdAt: '2023-01-01 10:00:00', updatedAt: '2023-01-01 11:11:11', book: { id: 10, title: 'test11', image: '../bookimages/that_time_i_got_reincarnated_as_a_slime_volume_1.jpeg' }, tags: [{ id: 2, name: 'Manga3' }, { id: 3, name: 'Review' }] },
]
...
export default function Myblog() {
    ...
    const [myblogs, setMyblogs] = useState(bloglist);
                                ...
                                <div className="flex flex-row">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex flex-row mb-3">
                                            <p className="font-kanit font-extralight text-sm text-gray-400 ml-2">Created at: {createTime}</p>
                                        ...
                                        <Dialog open={opendel} onClose={handleClosedel}>
                                            <form onSubmit={handleSubmitdel}>
                                                ...
                                                <DialogActions>
                                                    ...
                                                    <Button type="submit" onClick={() => Delblog(blog.id)}>ยืนยัน</Button>
                                                </DialogActions>
                                            </form>
                                        </Dialog>
                                    </div>
