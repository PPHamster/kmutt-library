...
export default function RoomforSt(props) {
    ...
    function delroom(Id) {
        ...
        const index = roomdata.findIndex((c) => c.id === Id);
            ...
            <section className='h-[350px] w-[250px] bg-white rounded-[0.55rem] p-[25px] select-none drop-shadow-md hover:drop-shadow-lg'>
                <div className=''>
                    ...
                    <div className='ml-4 mr-4'>
                        ...
                        <Link to={`/staff/room/${props.roomid}/edit`}>
                        <button
                ...
                <form onSubmit={handleSubmitDel}>
                    ...
                    <DialogContent>
                        <DialogContentText className='px-5'>
                            คุณแน่ใจหรือไม่ว่าต้องการลบ {props.roomname} ออก
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                        <Button onClick={handleCloseDel}>ยกเลิก</Button>
                        <Button type="submit" onClick={() => delroom(props.roomid)}>ยืนยัน</Button>
                    </DialogActions>
                </form>
            </Dialog>
            </section>
