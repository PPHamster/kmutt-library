...
export default function StaffEvent() {
    ...
    function renameCategory(categoryId, inputEditValue) {
        ...
        const categoryIndex = eventcategory.findIndex(c => c.id === categoryId);
        ...
        eventcategory[categoryIndex].name = inputEditValue;
    }
    ...
    function delCategory(CategoryId) {
        ...
        const index = eventcategory.findIndex((c) => c.id === CategoryId);
