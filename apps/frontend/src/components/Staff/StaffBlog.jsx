            ...
            <div className="w-full h-[700px] pt-[2rem] px-[8rem] max-sm:px-[20px] max-lg:px-[4rem]">
                <div className="w-full ">
                    <div className='pl-[5%]'>
                        ...
                        <button
                            className="absolute left-[25%] -translate-y-[72px] w-auto p-[8px] px-[20px] h-auto 
                        ...
                        >see all</button>
                        <button className="absolute left-[28%] -translate-y-[72px] w-auto p-[8px] h-auto border-2 rounded-full bg-[#3AAF3C]
