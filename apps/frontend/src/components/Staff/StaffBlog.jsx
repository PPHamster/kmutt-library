...
export default function StaffBlog() {
  ...
  const [value, setValue] = useState(null);
    ...
    function renameCategory(categoryId, inputEditValue) {
        ...
        const categoryIndex = tag.findIndex(c => c.id === categoryId);
        ...
        tag[categoryIndex].name = inputEditValue;
    }
    ...
    function delCategory(tagId) {
        // Find the index of the category with the matching id
        const index = tag.findIndex((c) => c.id === tagId);
