  ...
  return (
    <div className='mx-[90px] -my-[16px] after:content-[""] after:table'>
            ...
            <div className='flex justify-center items-center w-2/4 px-5 float-left max-sm:w-full max-lg:w-2/4 max-lg:p-2'>
                ...
                <button
                    className="-translate-x-2 -translate-y-1 w-auto p-[10px] ml-[44px] mb-5 rounded-full bg-[#F44336] border-2 hover:bg-[#c5342a] font-regular font-poppins text-white text-md mt-[16px] ease-out duration-300"
                    onClick={props.onClick}
