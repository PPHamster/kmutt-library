    ...
    return (
        <>
            <div className="flex flex-row w-full h-[700px] bg-[#FFD4D4] mt-[9rem]">
                ...
                <div className="ml-[20vw] mt-[4rem] h-[550px] ">
                    <div>
                        <Event
                            eventname=''
                            category=''
                    ...
                    <div className="ml-[4vw]">
                        <Link to='/event'>
                            <div className='w-[120px] h-[40px] ml-[0px] text-center pt-[5px] rounded-full border-transparent hover:border-[#5c4b4b] border-2 hover:bg-[#5c4b4b] font-regular font-poppins text-[#696969] text-md my-[20px] ease-out duration-300 bg-[#ab8e8e]'>
